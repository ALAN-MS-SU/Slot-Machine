...
export default function Page() {
  ...
  return (
    <div className="w-screen h-screen flex items-center">
      <Menu Repeat={Repeat} Sort={Sort} Items={Items} Slots={Slots} SetSlots={SetSlots} SetItems={SetItems} />
      <Build Repeat={Repeat} Sort={Sort} SetSort={SetSort} Slots={Slots} Items={Items} />
    </div>
  );
}
